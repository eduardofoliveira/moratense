...
const executar = async () => {
    let dataInicial = (0, date_fns_1.parse)((0, date_fns_1.format)((0, date_fns_1.subDays)(new Date(), 5), "yyyy-MM-dd"), "yyyy-MM-dd", new Date());
    const dataTermino = (0, date_fns_1.parse)((0, date_fns_1.format)((0, date_fns_1.addDays)(new Date(), 2), "yyyy-MM-dd"), "yyyy-MM-dd", new Date());
    const knex = connectionManager_1.default.getConnection();
    while ((0, date_fns_1.format)(dataInicial, "yyyy-MM-dd") !== (0, date_fns_1.format)(dataTermino, "yyyy-MM-dd")) {
        console.log(`Processando: ${(0, date_fns_1.format)(dataInicial, "yyyy-MM-dd")} 03:00:00' AND '${(0, date_fns_1.format)((0, date_fns_1.addDays)(dataInicial, 1), "yyyy-MM-dd")} 02:59:59`);
        ...
        WHERE
          DT between '${(0, date_fns_1.format)(dataInicial, "yyyy-MM-dd")}' AND '${(0, date_fns_1.format)(dataInicial, "yyyy-MM-dd")}'
        GROUP BY
          DT
    `);
        if (result.length === 0 || result[0].quantidade < 30) {
            console.log("Processar DIA: ", (0, date_fns_1.format)(dataInicial, "yyyy-MM-dd"));
            await knex.raw(`
        ...
        WHERE  carros.removido = 0
              AND data_saida_garagem BETWEEN
                  '${(0, date_fns_1.format)(dataInicial, "yyyy-MM-dd")} 03:00:00' AND '${(0, date_fns_1.format)((0, date_fns_1.addDays)(dataInicial, 1), "yyyy-MM-dd")} 02:59:59'
      ...
      `);
        ...
        dataInicial = (0, date_fns_1.addDays)(dataInicial, 1);
    }
    await knex.destroy();
    process.exit(0);
};
